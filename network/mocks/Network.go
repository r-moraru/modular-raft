...
// SendHeartbeat provides a mock function with given fields: ctx, peerId, prevIndex
func (_m *Network) SendHeartbeat(ctx context.Context, peerId string, prevIndex uint64) network.ResponseStatus {
	ret := _m.Called(ctx, peerId, prevIndex)
	...
	var r0 network.ResponseStatus
	if rf, ok := ret.Get(0).(func(context.Context, string, uint64) network.ResponseStatus); ok {
		r0 = rf(ctx, peerId, prevIndex)
	} else {
		r0 = ret.Get(0).(network.ResponseStatus)
	}
...
//   - peerId string
//   - prevIndex uint64
func (_e *Network_Expecter) SendHeartbeat(ctx interface{}, peerId interface{}, prevIndex interface{}) *Network_SendHeartbeat_Call {
	return &Network_SendHeartbeat_Call{Call: _e.mock.On("SendHeartbeat", ctx, peerId, prevIndex)}
}

func (_c *Network_SendHeartbeat_Call) Run(run func(ctx context.Context, peerId string, prevIndex uint64)) *Network_SendHeartbeat_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Network_SendHeartbeat_Call) Return(_a0 network.ResponseStatus) *Network_SendHeartbeat_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Network_SendHeartbeat_Call) RunAndReturn(run func(context.Context, string, uint64) network.ResponseStatus) *Network_SendHeartbeat_Call {
	_c.Call.Return(run)
	return _c
}
